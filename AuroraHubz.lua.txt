...
-- ── Habilita a GUI da Backpack (necessário para tools aparecerem na barra) ─
local SG = game:GetService("StarterGui")
local function showBackpackGui()
    pcall(function()
...
local function placeInBackpack(tool)
    task.spawn(function()
        showBackpackGui()  -- garante que a barra esteja visível antes de inserir
...
local function disableFrontFlip()
    ...
    -- Só esconde a GUI se nenhum flip estiver ativo
    if not _backFlipTool then
