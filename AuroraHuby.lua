...
-- Detecta sprint via HumanoidStateType (mais compatível com executors)
task.spawn(function()
    pcall(function()
        ...
        while true do
            ...
            if hum then
                ...
                local isSprinting = speed > (walkSpeedVal + 2)
                if isSprinting ~= lastState then
                    lastState = isSprinting
